...
$(function(){	
	...
	myDateField('startdate','toolbar1','应还日期从',78,2,915,27,100);
	myDateField('enddate','toolbar1','到',20,2,1100,27,100);
	var str='<div style="float:right;margin-top:1px;margin-right:10px;"><a id="chaxun" href="javascript:void(0)" class="easyui-linkbutton">查询</a></div>';
	$('#toolbar1').append(str);
	$('#chaxun').linkbutton({});
	$('#startdate').datebox('setValue','1900-01-01');
	var enddate=getTime();
...
function fnLoadGridData(){
	var p={};
	p.date1=$('#startdate').datebox('getValue');
	p.date2=$('#enddate').datebox('getValue');
	var rs=myRunSqlProcedure('grid_5',p);
